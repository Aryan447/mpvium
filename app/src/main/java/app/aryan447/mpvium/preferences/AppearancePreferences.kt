...
class AppearancePreferences(
  ...
  val topRightControls =
    preferenceStore.getString(
      "top_right_controls",
      "AUDIO_TRACK,SUBTITLES,BRIGHTNESS,MORE_OPTIONS",
    )
  ...
  val portraitBottomControls =
    preferenceStore.getString(
      ...
      "AUDIO_TRACK,SUBTITLES,PLAYBACK_SPEED,BOOKMARKS_CHAPTERS,PICTURE_IN_PICTURE,MORE_OPTIONS,AB_LOOP,EXPLAIN,HOLD_MODE_SWITCH,BRIGHTNESS",
    )
