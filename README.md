...
**mpvium is a fork of [mpv-android](https://github.com/mpv-android/mpv-android), built on the libmpv library. It aims
...
the [Issues](https://github.com/aryan447/mpvium/issues) section.**
...
### Stable Release
Download the latest stable version from the [GitHub releases page](https://github.com/aryan447/mpvium/releases).

[![Download Release](https://img.shields.io/badge/Download-Release-blue?style=for-the-badge)](https://github.com/aryan447/mpvium/releases)
...
[![Download Preview Builds](https://img.shields.io/badge/Download-Preview%20Builds-red?style=for-the-badge)](https://aryan447.github.io/mpvium/)
...
If you find mpvium useful, consider supporting the development:

[![UPI](https://img.shields.io/badge/UPI-aryan447@upi-blue?style=for-the-badge&logo=google-pay&logoColor=white)](upi://pay?pa=aryan447@upi)
...
<a href="https://www.star-history.com/#aryan447/mpvium&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=aryan447/mpvium&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=aryan447/mpvium&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=aryan447/mpvium&type=date&legend=top-left" />
 </picture>
</a>
